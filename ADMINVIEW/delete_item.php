...
<ul class="topnav">
  ...
  <li><a class="active" href="delete_item.php">Delete</a></li>
...
<br>
<center><div class="i"><form action="delete.php" method="post"><br>
<c class="b">Enter Category : </c><br><input type="text" name="category" required/><br> 
<c class="b">Product ID: </c><br><input type="text" name="id" required/><br><br>
